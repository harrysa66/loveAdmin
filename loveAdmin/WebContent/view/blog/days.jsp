	...
	<!-- Search panel start -->
 	 ...
 	 <form id="searchForm">
 	 	<p class="ui-fields">
            ...
            <input name="memorialTitle" class="easyui-box ui-text" style="width:100px;">
            <label>状态:</label>  
     ...
     <div id="edit-win" class="easyui-dialog" title="修改" data-options="closed:true,modal:true" style="width:400px;height:250px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 ...
     		 <div class="ui-edit">
	     	   <div class="ftitle">纪念日信息</div>    
	           <div class="fitem">  
	               <label>标题:</label>  
	               <input class="easyui-validatebox" type="text" name="memorialTitle" data-options="required:true">
	           </div>  
	           <div class="fitem">  
	               <label>日期:</label>  
	               <input id="memorialDate" class="easyui-datetimebox" name="memorialDate"     
        data-options="required:true,editable:false" value="" style="width:150px">
	           </div> 
	         </div>
     	</form>
  	 </div> 
...
<script type="text/javascript" src="${msUrl}/js/ux/blog/days.js"></script>
  </body>
</html>
